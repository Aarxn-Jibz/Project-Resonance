...
export default function Chaos() {
  return (
    <div className="min-h-screen w-full bg-[#050505] text-white flex flex-col font-mono relative overflow-x-hidden selection:bg-red-500/30">
      ...
      <nav className="fixed top-0 left-0 w-full px-3 py-4 sm:p-6 flex justify-between items-center gap-3 z-50 bg-[#050505]/80 backdrop-blur-md border-b border-red-500/20">
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
           <div className="w-2 h-2 rounded-full bg-red-500 animate-ping" />
           <span className="text-[9px] sm:text-xs tracking-[0.12em] sm:tracking-[0.3em] font-bold text-red-500 uppercase leading-tight">
             SYS_OVERRIDE_ACTIVE
           </span>
        </div>
        ...
        <button 
          ...
          className="min-h-11 shrink-0 text-[10px] sm:text-xs tracking-[0.08em] sm:tracking-[0.2em] text-gray-400 border border-gray-600 px-3 sm:px-4 py-2 hover:text-white hover:border-white hover:bg-white/5 transition-all uppercase"
        >
          <span className="sm:hidden">[ Return ]</span>
          <span className="hidden sm:inline">[ Return to safe zone ]</span>
        </button>
      </nav>

      {/* Background Decor / Glitch Effects */}
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[36rem] h-[36rem] sm:w-[1000px] sm:h-[1000px] bg-[radial-gradient(circle_at_center,rgba(225,0,117,0.03)_0%,transparent_60%)]" />
      ...
      <main className="flex-1 flex flex-col items-center pt-28 sm:pt-32 pb-24 px-3 sm:px-6 relative z-10 max-w-6xl mx-auto w-full">
        ...
        <div className="text-center mb-10 sm:mb-16 w-full">
          ...
          <p className="text-gray-400 text-xs sm:text-sm tracking-wider sm:tracking-widest uppercase max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mb-12">
          ...
          {/* Box 1: Origins */}
          <div className="border border-white/10 bg-[#0a0a0a] p-4 sm:p-6 relative group hover:border-[#e10075]/50 transition-colors">
          ...
          <div className="border border-white/10 bg-[#0a0a0a] p-4 sm:p-6 relative group hover:border-[#d4ff00]/50 transition-colors">
          ...
          {/* Box 3: The Incident */}
          <div className="border border-red-500/30 bg-red-500/5 p-4 sm:p-6 relative group hover:bg-red-500/10 transition-colors">
        ...
        <div className="w-full max-w-4xl border border-gray-800 bg-[#050505] rounded-sm overflow-hidden">
          ...
          <div className="p-3 sm:p-6 text-[10px] sm:text-xs font-mono leading-loose text-gray-400 h-64 overflow-y-auto overflow-x-auto custom-scrollbar relative">
      ...
      <div className="fixed bottom-10 left-6 text-[10px] text-red-500/40 tracking-[0.4em] origin-bottom-left -rotate-90 z-0 hidden md:block">
        SYSTEM_FAILURE // 0xCC001 // RECURSIVE_BIT_CRUSH
      </div>

      {/* Bottom Bar */}
      <footer className="fixed bottom-0 w-full px-3 py-3 sm:p-4 border-t border-red-500/20 bg-[#050505]/80 backdrop-blur-md flex justify-between gap-3 font-mono text-[8px] sm:text-[9px] text-red-500/70 z-50">
        <div><span className="sm:hidden">STATUS: UNSTABLE</span><span className="hidden sm:inline">STATUS: UNSTABLE // MANUAL REBOOT SUGGESTED</span></div>
